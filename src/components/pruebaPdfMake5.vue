<template>
  <div class="main">
    <p>Esto es para mis pruebas no lo borreís ni toqueís, gracias 😊😊😊😊</p>
...
export default {
  ...
  methods: {
    ...
    saveReportOfAllToPDF() {
      ...
      const assessedName = "HR/Area manager/Pair/Collaborator";
      const evaluatorName = "María Sánchez/Sales Department";
      ...
      Promise.all(chartImagesTmp).then((res) => {
        ...
        // User name
        doc.content.push({
          absolutePosition: { x: X_MARGIN + 158, y: 209 },
          text: evaluatorName,
          fontSize: 9,
        });
